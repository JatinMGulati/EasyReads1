      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-3xl font-bold text-white">EasyReads</h3>
            <p className="text-sm mt-3 text-gray-400 max-w-xs md:max-w-sm text-center md:text-left">
              EasyReads: A simple library catalog and user portal. Browse categories, view digital content, and manage your profile.
            </p>
          </div>
        ...
        <div className="mt-12 text-center border-t border-gray-700 pt-8">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} EasyReads. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
